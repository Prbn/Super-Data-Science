...
os.getcwd()
os.chdir('D:\\Work\\ML\\Super Data Science\\Machine Learning A-Z Template Folder\\Part 3 - Classification\\Section 17 - Kernel SVM\\Kernel_SVM')
...
# degree and gamma can be played to improve the model
