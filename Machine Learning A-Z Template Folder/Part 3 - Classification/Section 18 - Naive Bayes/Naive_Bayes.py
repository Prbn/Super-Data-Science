...
os.getcwd()
os.chdir('D:\\Work\\ML\\Super Data Science\\Machine Learning A-Z Template Folder\\Part 3 - Classification\\Section 18 - Naive Bayes\\Naive_Bayes')
...
# Using the GaussianNB class from the naive_bayes library of sklearn #
#-----------------------------------------------------#
from sklearn.naive_bayes import GaussianNB

# Creating an object of SVC class and this object will be the classifier
classifier = GaussianNB()
# No parameters are required for this classifier
