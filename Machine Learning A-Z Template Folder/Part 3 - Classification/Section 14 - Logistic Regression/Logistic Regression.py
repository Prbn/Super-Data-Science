...
os.getcwd()
os.chdir('D:\\Work\\ML\\Super Data Science\\Machine Learning A-Z Template Folder\\Part 3 - Classification\\Section 14 - Logistic Regression\\Logistic_Regression')
...
# Fitting the Logistic Regreesion to the Dataset
# Using the LogisticRegression class from the linear_model library of sklearn #
#---------------------------------------------------------------------------#
from sklearn.linear_model import LogisticRegression

# Creating an object of Logistic Regreesion class and this object will be the classifier
classifier = LogisticRegression(random_state = 0 )
# LogisticRegression() is like a function that returns an object of it self
