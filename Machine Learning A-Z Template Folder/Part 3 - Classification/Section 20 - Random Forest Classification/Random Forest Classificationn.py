...
os.getcwd()
os.chdir('D:\\Work\\ML\\Super Data Science\\Machine Learning A-Z Template Folder\\Part 3 - Classification\\Section 20 - Random Forest Classification\\Random_Forest_Classification')
...
# Random Forest does not require feature scaling as the trees are not algorithms based on the Euclidean distance
...
# Using the RandomForestClassifier class from the ensemble library of sklearn #
#---------------------------------------------------------------------------#
from sklearn.ensemble import RandomForestClassifier

# Creating an object of DecisionTreeClassifier class and this object will be the classifier
classifier = RandomForestClassifier(n_estimators = 10, criterion = 'entropy', random_state = 0)
# n_estimators is the parameter that denotes the number of trees in the classifier
# Making Random Forest based on entropy, by setting the criterion parametet to entropy
