...
os.getcwd()
os.chdir('D:\\Work\\ML\\Super Data Science\\Machine Learning A-Z Template Folder\\Part 2 - Regression\\Section 9 - Random Forest Regression\\Random_Forest_Regression')
...
# Using the RandomForestRegressor class from the ensemble library of sklearn #
#---------------------------------------------------------------------------#
from sklearn.ensemble import RandomForestRegressor

# Creating an object of Random Forest Regreesion class and this object will be the regressor
regressor = RandomForestRegressor(n_estimators=300, random_state = 0 )
# RandomForestRegressor() is like a function that returns an object of it self
